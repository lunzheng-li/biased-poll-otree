...
26/04 9:30 pm
I think the logics are clear now, I should start from the beginning to set vars and make comments
...
class Constants(BaseConstants):
    ...
    num_rounds = 6 # the total number of round, including the practice round.
    practice_rounds = 1
